...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../parking.test-samples';

import { ParkingService, RestParking } from './parking.service';

const requireRestSample: RestParking = {
  ...sampleWithRequiredData,
  date_creation: sampleWithRequiredData.date_creation?.format(DATE_FORMAT),
};
